...
interface Question { id: string; type: QuestionType; label: string; required?: boolean; options?: string[]; maxLength?: number; min?: number; max?: number; showIf?: { questionId: string; equals: any } }
interface Section { id: string; title: string; questions: Question[] }
interface Assessment { id: number; jobId: number; title: string; sections: Section[]; updatedAt: number }

export default function AssessmentBuilder({ params }: { params: { jobId: string } }) {
